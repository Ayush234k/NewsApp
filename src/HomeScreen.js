  ...
  const HomeScreen = ({navigation}) => {
    ...
    const getData = async () => {
      ...
      const response = await fetch(
        `https://newsapi.org/v2/top-headlines?country=in&apiKey=8e5e4aed8b6442a2b8c2a48c31b5fcfa&category=${Category[Select].category}`,
      );
    ...
    const getData2 = async category => {
      setLaoding(true);
      const response = await fetch(
        `https://newsapi.org/v2/top-headlines?country=in&apiKey=8e5e4aed8b6442a2b8c2a48c31b5fcfa&category=${category}`,
      );
